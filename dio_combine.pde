  ...
  */
  ...
  switch(gameState){
    ...
    break;
     ...
     case GAME_START_B:
      ...
      if(mouseX > 300 && mouseX < 500  && mouseY > OPENDOOR_TOP && mouseY < OPENDOOR_BOTTOM){ 
        ...
        if(mousePressed) {HP2=1;SP2=0; gameState=GAME_RUN_B; mousePressed = false;initGame();}                                                                //BUTTON Click gameState to GAME_RUN
     }
      break;
    ...
    break;
      ...
      if(SP2>=14&&dioX2==400&&dioY2==100) gameState = GAME_START_C;      //GAME_OVER condition
      break;
      ...
      if(mouseX > 550 && mouseX < 750  && mouseY > 200 && mouseY < 600){ 
        ...
        if(mousePressed) {HP3=1;SP3=0;x=PLAYER_INIT_X;y=PLAYER_INIT_Y; gameState=GAME_RUN_C;initGame2();
        moneyX=initmoneyX; moneyY=initmoneyY;priestY=0;}                                                                //BUTTON Click gameState to GAME_RUN
     }
      break;
      case GAME_RUN_C:
